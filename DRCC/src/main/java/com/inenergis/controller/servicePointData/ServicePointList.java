...
import com.inenergis.controller.carousel.ServicePointCarousel;
...
public class ServicePointList implements Serializable {
    ...
    Logger log = LoggerFactory.getLogger(ServicePointList.class);
    ...
    private LazyAgreementPointMapDataModel agreementPointMapLazyModel;
    ...
    private ServicePointCarousel servicePointCarousel = new ServicePointCarousel();
    private GasServicePointCarousel gasServicePointCarousel = new GasServicePointCarousel();
    @PostConstruct
    public void init() {
        final String servicePointId = ParameterEncoderService.getDefaultDecodedParameter();
    ...
    public void searchPremises() {
        ...
        agreementPointMapLazyModel = new LazyAgreementPointMapDataModel(this.address, this.city, this.postCode, this.servicePointId, this.premisesId, this);
    ...
    private void showAgreementPointMap(AgreementPointMap apm) {
        ...
        if (prem != null) {
            ...
            agreementPointMapLazyModel = new LazyAgreementPointMapDataModel(null, null, null, null, prem.getPremiseId(), this);
    ...
    private void loadHistory() {
        ...
        if (sa_sp.getCommodity().equals("Gas")) {
    ...
    public void onServiceAgreementSelect(SelectEvent event) throws IOException {
        AgreementPointMap apm = (AgreementPointMap) event.getObject();
        if (apm != null) {
            FacesContext.getCurrentInstance().getExternalContext().redirect("CustomerList.xhtml?o=" + ParameterEncoderService.encode(apm.getServiceAgreement().getServiceAgreementId()) +"&c="+ ParameterEncoderService.encode(apm.getCommodity()));
    ...
    public void loadCarouselData() {
        ...
        if(sa_sp.getCommodity().equals("Gas")){
            if (sa_sp != null) {
                premiseDetails = gasServicePointCarousel.printServicePointCarousel(sa_sp);
            }
        }
        else {
            if (sa_sp != null) {
    ...
    public void setAgreementPointMapLazyModel(LazyAgreementPointMapDataModel agreementPointMapLazyModel) {
    ...
    public void createEnergyUsageModel() {
        ...
        if (energyUsageViewType.equals("hourly")) {
            getIntervalData().forEach(intervalData -> costs.set(intervalData.getLocalDateTime().getHour(), intervalData.getValue().doubleValue()));
        } else {
