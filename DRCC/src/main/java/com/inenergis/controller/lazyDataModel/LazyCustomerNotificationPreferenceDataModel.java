...
@Transactional
public class LazyCustomerNotificationPreferenceDataModel extends LazyDataModel<CustomerNotificationPreference> {
	...
	Logger log =  LoggerFactory.getLogger(LazyCustomerNotificationPreferenceDataModel.class);
...
//	private Account account;
	...
	private List<CustomerNotificationPreference> datasource = new ArrayList<CustomerNotificationPreference>();
	private AgreementPointMapList agreementPointMapList;

//	private boolean accountJoined = false;
//	private boolean personJoined = false;

	private ServiceAgreement emptyServiceAgreement = new ServiceAgreement();

	public LazyCustomerNotificationPreferenceDataModel(AgreementPointMapList agreementPointMapList){
		this.agreementPointMapList = agreementPointMapList;
	}

	public LazyCustomerNotificationPreferenceDataModel(String personId, String saId, String name, String address, String city, String postCode, String premisesId, String accountId, String phone, AgreementPointMapList agreementPointMapList){
	...
	@Override
	public Object getRowKey(CustomerNotificationPreference notificationPreference){
		return notificationPreference.getRowKey();
	}

	@Override
	public CustomerNotificationPreference getRowData(String rowKey){
		Long l = Long.valueOf(rowKey);
		for(CustomerNotificationPreference notificationPreference : datasource){
	...
	@Override
	public List<CustomerNotificationPreference> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {

		Session session = (Session)agreementPointMapList.getEntityManager().getDelegate();
		Criteria c = session.createCriteria(CustomerNotificationPreference.class);
		...
		Criteria c2 = session.createCriteria(CustomerNotificationPreference.class);
	...
	public List<CustomerNotificationPreference> getDatasource() {
		return datasource;
	}

	public void setDatasource(List<CustomerNotificationPreference> datasource) {
