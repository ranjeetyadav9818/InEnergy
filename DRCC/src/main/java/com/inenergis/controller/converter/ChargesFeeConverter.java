...
@FacesConverter(value = "chargesFeeConverter")
public class ChargesFeeConverter implements Converter {

    @Inject
    ChargesFeeService chargesFeeService;

    @Override
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        try {
            return chargesFeeService.getById(Long.valueOf(value));
