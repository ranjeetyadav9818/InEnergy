...
import com.inenergis.entity.GasMeter;
...
@Stateless
public class GasServicePointCarousel {

    private static final Logger log = LoggerFactory.getLogger(GasServicePointCarousel.class);
    ...
    public List<DataBeanList> printServicePointCarousel(AgreementPointMap sa_sp) {
        ...
        GasMeter meter = (GasMeter) servicePoint.getMeter();
        ...
        mBeans.add(new DataBean("Comms ID", servicePoint.getCommsId()));
        ...
        // Deliver Presure
        List<DataBean> prBeans = new ArrayList<DataBean>();
        prBeans.add(new DataBean("Delivered Pressure",servicePoint.getDeliveredPressure() ));
        prBeans.add(new DataBean("Service Pressure", servicePoint.getServicePressure()));
        prBeans.add(new DataBean("Meter Pressure",servicePoint.getMeterPressure() ));
        DataBeanList pressuredata = new DataBeanList("Pressure", "custom-icon-meter", prBeans);
        servicePointDetails.add(pressuredata);
        ...
        dBeans.add(new DataBean("Regulator", servicePoint.getRegulatorNumber()));
        dBeans.add(new DataBean("Regulator Badge", servicePoint.getRegulatorBadgeNumber()));
        dBeans.add(new DataBean("City Gate", servicePoint.getCityGateNumber()));
        dBeans.add(new DataBean("Feeder", servicePoint.getFeeder()));
       //todogas dBeans.add(new DataBean("Circuit", servicePoint.getCircuitNumber()));
        ...
        piBeans.add(new DataBean("Pressure Class", servicePoint.getServicePressureClass()));
