...
@Stateless
@Transactional
public class GasServiceAgreementDao {
    ...
    public List<GasServiceAgreement> getAll() {
        return entityManager.createQuery("from ServiceAgreement").getResultList();
    }

    public GasServiceAgreement getById(String id) {
        return entityManager.find(GasServiceAgreement.class, id);
    }

    public List<GasServiceAgreement> getAllByIds(Collection<String> ids) {
