...
public class ArrayOfStatisticsSummary {

    @XmlElement(name = "StatisticsSummary", nillable = true)
    protected List<StatisticsSummary> statisticsSummary;
