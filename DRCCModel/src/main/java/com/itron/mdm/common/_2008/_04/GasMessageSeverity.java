...
@XmlEnum
public enum GasMessageSeverity {
    ...
    public static GasMessageSeverity fromValue(String v) {
        for (GasMessageSeverity c: GasMessageSeverity.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
