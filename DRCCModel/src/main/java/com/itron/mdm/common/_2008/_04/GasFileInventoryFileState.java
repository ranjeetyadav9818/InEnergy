...
@XmlEnum
public enum GasFileInventoryFileState {
    ...
    GasFileInventoryFileState(String v) {
        value = v;
    }
    ...
    public static GasFileInventoryFileState fromValue(String v) {
        for (GasFileInventoryFileState c: GasFileInventoryFileState.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
