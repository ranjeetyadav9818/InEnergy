...
public class ArrayOfServiceLogMessage {

    @XmlElement(name = "ServiceLogMessage", nillable = true)
    protected List<ServiceLogMessage> serviceLogMessage;
     ...
     * {@link ServiceLogMessage }
     * 
     * 
     */
    public List<ServiceLogMessage> getServiceLogMessage() {
        if (serviceLogMessage == null) {
            serviceLogMessage = new ArrayList<ServiceLogMessage>();
        }
        return this.serviceLogMessage;
    }
