...
public class ArrayOfManageEventRequest {

    @XmlElement(name = "ManageEvent_Request", nillable = true)
    protected List<ManageEventRequest> manageEventRequest;
     ...
     * {@link ManageEventRequest }
     * 
     * 
     */
    public List<ManageEventRequest> getManageEventRequest() {
        if (manageEventRequest == null) {
            manageEventRequest = new ArrayList<ManageEventRequest>();
        }
