...
public class ExecuteBatchSave {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link CurtailmentEventSaveBatchRequest }{@code >}
     *     
     */
    public JAXBElement<CurtailmentEventSaveBatchRequest> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<CurtailmentEventSaveBatchRequest> value) {
        this.request = value;
    }
