...
public enum ManageEventAction {
    ...
    public static ManageEventAction fromValue(String v) {
        for (ManageEventAction c: ManageEventAction.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
