...
public class ArrayOfManageEventResponse {

    @XmlElement(name = "ManageEvent_Response", nillable = true)
    protected List<ManageEventResponse> manageEventResponse;
     ...
     * {@link ManageEventResponse }
     * 
     * 
     */
    public List<ManageEventResponse> getManageEventResponse() {
        if (manageEventResponse == null) {
            manageEventResponse = new ArrayList<ManageEventResponse>();
        }
