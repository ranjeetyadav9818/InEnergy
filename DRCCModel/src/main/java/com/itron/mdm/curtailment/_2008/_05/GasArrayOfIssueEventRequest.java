...
public class GasArrayOfIssueEventRequest {

    @XmlElement(name = "IssueEvent_Request", nillable = true)
    protected List<GasIssueEventGasRequest> issueEventRequest;
     ...
     * {@link GasIssueEventGasRequest }
     * 
     * 
     */
    public List<GasIssueEventGasRequest> getIssueEventRequest() {
        if (issueEventRequest == null) {
            issueEventRequest = new ArrayList<GasIssueEventGasRequest>();
        }
