...
public class GasIssueEvent {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GasIssueEventGasRequest }{@code >}
     *     
     */
    public JAXBElement<GasIssueEventGasRequest> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<GasIssueEventGasRequest> value) {
        this.request = value;
    }
