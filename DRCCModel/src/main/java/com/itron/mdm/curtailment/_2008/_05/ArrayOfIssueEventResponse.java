...
public class ArrayOfIssueEventResponse {

    @XmlElement(name = "IssueEvent_Response", nillable = true)
    protected List<IssueEventResponse> issueEventResponse;
     ...
     * {@link IssueEventResponse }
     * 
     * 
     */
    public List<IssueEventResponse> getIssueEventResponse() {
        if (issueEventResponse == null) {
            issueEventResponse = new ArrayList<IssueEventResponse>();
        }
