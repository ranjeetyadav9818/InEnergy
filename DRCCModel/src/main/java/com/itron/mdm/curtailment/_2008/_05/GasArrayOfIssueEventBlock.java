...
public class GasArrayOfIssueEventBlock {

    @XmlElement(name = "IssueEventBlock", nillable = true)
    protected List<GasIssueEventBlock> gasIssueEventBlock;
     ...
     * {@link GasIssueEventBlock }
     * 
     * 
     */
    public List<GasIssueEventBlock> getIssueEventBlock() {
        if (gasIssueEventBlock == null) {
            gasIssueEventBlock = new ArrayList<GasIssueEventBlock>();
        }
        return this.gasIssueEventBlock;
    }
