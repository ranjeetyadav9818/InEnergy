...
public class ArrayOfIssueEventServicePoint {

    @XmlElement(name = "IssueEventServicePoint", nillable = true)
    protected List<IssueEventServicePoint> issueEventServicePoint;
     ...
     * {@link IssueEventServicePoint }
     * 
     * 
     */
    public List<IssueEventServicePoint> getIssueEventServicePoint() {
        if (issueEventServicePoint == null) {
            issueEventServicePoint = new ArrayList<IssueEventServicePoint>();
        }
        return this.issueEventServicePoint;
    }
