...
public class GasManageEventRequest
    extends GasRequestBase
{

    @XmlElement(name = "Action", required = true)
    @XmlSchemaType(name = "string")
    protected GasManageEventAction action;
     ...
     * @return
     *     possible object is
     *     {@link GasManageEventAction }
     *     
     */
    public GasManageEventAction getAction() {
        return action;
    }
     ...
     *     
     */
    public void setAction(GasManageEventAction value) {
        this.action = value;
    }
