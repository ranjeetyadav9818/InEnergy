...
public enum BidSubmissionIsoInterval {
    ...
    private Integer minutesNumber;



    BidSubmissionIsoInterval(final Integer hourNumber, final Integer minutesNumber) {
        this.hourNumber =hourNumber;
        this.minutesNumber =minutesNumber;
        if (hourNumber == null) {
            this.hour = LocalTime.of(minutesNumber / 60, minutesNumber % 60);
        } else {
    ...
    public String getString() {
        if (this.hourNumber == null){
            return (this.minutesNumber + " minutes");
        } else {
            return ConstantsProviderModel.HOUR_FORMATTER.format(this.hour);
        }
    }

    public Integer getMinutes(){ return this.minutesNumber;}
