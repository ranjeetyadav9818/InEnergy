 ...
 */
@Entity
@Table(name="GAS_PDP_SR_NOTIFICATIONS")
@NamedQuery(name="GasPdpSrNotification.findAll", query="SELECT p FROM GasPdpSrNotification p")
public class GasPdpSrNotification implements Serializable {
	...
	private GasPdpSrParticipant gasPdpSrParticipant;
	private GasPdpSrEvent gasPdpSrEvent;
	private PdpSrVendor gasPdpSrVendor;
	private GasPdpSrNotification duplicateOf;
	private String voiceRecordFileName;

	public GasPdpSrNotification() {
	}
	...
	@ManyToOne
	@JoinColumn(name="GAS_PDP_SR_PARTICIPANTS_PARTICIPANT_ID")
	public GasPdpSrParticipant getPdpSrParticipant() {
		return this.gasPdpSrParticipant;
	}

	public void setPdpSrParticipant(GasPdpSrParticipant gasPdpSrParticipant) {
		this.gasPdpSrParticipant = gasPdpSrParticipant;
	}


	//bi-directional many-to-one association to PdpSrEvent
	@ManyToOne
	@JoinColumn(name="GAS_PDP_SR_EVENT_EVENT_ID")
	...
	@ManyToOne
	@JoinColumn(name="GAS_PDP_SR_VENDOR_VENDOR_ID")
	public PdpSrVendor getPdpSrVendor() {
		return this.gasPdpSrVendor;
	}

	public void setPdpSrVendor(PdpSrVendor gasPdpSrVendor) {
		this.gasPdpSrVendor = gasPdpSrVendor;
	}
	...
	@ManyToOne
	@JoinColumn(name="GAS_DUPLICATE_OF")
	public GasPdpSrNotification getDuplicateOf() {
		return duplicateOf;
	}

	public void setDuplicateOf(GasPdpSrNotification duplicateOf) {
